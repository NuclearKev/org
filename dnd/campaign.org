...
*** Mailmen
    Saville will be hard at work in the shop, sewing away. If they ask him about
    a box that cannot be opened:
		...
		money gentlemen. Do you really think crafting trinkets and sewing people's pants
		makes me any money? Anyways, give me ehhh 20g and I'll tell you."
		...
		multiple days worth of customers. But I really need this message send."

		"It needs to go to a farm located about 4 days from Vet'ric. Don't
...
*** The Priest
    ...
    After they wait for Sunday:
		...
		**in a menacingly deep voice**
		"Good morning sirs. How are you all today?"
    ...
    He turns around and notices that someone knew is with them:
    "Who the hell are you?" (pointing to Cornelius)

    Corn: "I'm Cornelius. Who are you?"

    # ignore the next line; smartparens was acting up
    "

    Char: "How long have you been here?"

    "Since we left town..."

    *talking at the group
    ...
    *they answer*
    ...
    "I heard you guys were sent on a mission by the king and I've been wanting
    to go on an adventure. So I tagged along!"

    "You didn't think about asking us? or like lettings us know?"

    "Sometimes the smell for adventure just takes you over!"

    "Well... I don't really care if you come along. I guess it's up to these
    people."


    If they don't think that he is capable, he will show them his orb powers!
...
*** The Hags' Cellar
    ...
    At the last second, something jumps out of the cellar waaaay up high into
    the air. In comes back down and lands on the ground with a loud thud. Dust
    is everywhere, so you cannot tell what it is. One the dust clears, you see
    that it is another Minotaur. Except, this one is HUGE! Like twice the size
    of the others! It is also holding a very large pickaxe.

    It speaks:
    "Okay, here's the deal. Let me go free or I smash every last one of ya
    *horse noise*"

    In the middle of them talking back it, they're interrupted:

    Wart: "Minotaur, that's no way to talk to your saviors... with a loud thud. Dust
    is everywhere, so you cannot tell what it is. One the dust clears, you see
    that it is another Minotaur. Except, this one is HUGE! Like twice the size
    of the others! It is also holding a very large pickaxe.
    ...
    *horse noise*"
    ...
    In the middle of their reply, they are interrupted:

    Wart: "Minotaur, that's no way to talk to your saviors..."

    They turn around and it's Wart!!

    Mino: "Wart? Is that you!?"

    Wart: "Aye. Listen fellas, leave this guy alone. He doesn't want any
    trouble. Minotaur, have you sensed it?"

    Mino: "Aye."

    Wart: "Then you know what this means. We must get the others."

    Mino: "Okay, let's go!"

    Wart: "Of course you'd say that... You know as well as I, we can't just go
    roaming about! Whenever we do that, we end up getting enslaved, killed, or
    locked away. I've been following these few for a few days and I think they
    might be of use."

    Mino: "How do we know we can trust them?"

    "Well, it's the only chance we've got. Listen up you all, there is something
    terrible about to happen. Something worse than any of you can
    imagine. However, I can't give you the detail because I don't even know
    them. All I know is that we must find our other friends. We are the only
    ones able to stop what is going to happen. You see, Minotaur and I were
    created by the devil himself. The devil created us to be used as weapons for
    whatever reason. However, he made us with one fatal flaw, freewill unless
    being directly controlled. In order to stop whatever he has planned, we must
    be the others."

    Wart still: "There are 25 of us total."

    Wart still: "Sadly, I have no idea where the others are. But whoever we find
    next has to be someone by the name Magi. He is crucial to the success of
    this. You see, Magi is an advance teleporter and is able to teleport anyone,
    anywhere, at any time. He is the only one who has access to the island of
    Qufar, the safeheaven. Qufar is an island that is impossible to get to
    without teleporting. Well, that isn't entirely true. You can technically get
    there by taken an exit somewhere in the Dungeon of Doom. However, no one has
    ever found that exit before. Anyways, are you guys in? The world is in your
    hands."

    Wart will basically not let them say no. Once they agree:
    "Good. Minotaur will you hide in this forest until we return with Magi?"

    Mino: "Yes. What if someone tries to capture me?"

    Wart: "Don't let them. Minotaur, I give you permission to use your full
    power on anyone who stands in your way."

    Mino: "Y-Yessir!"

    "I hope you all don't mind if I tag along in your adventures for a little
    bit. We must find Magi and I'm the only one who he'll listen to."

    *Wart joins the party!

    *They start the quest [[Find the Cursed!]]
...
*** Let the Games Begin
    ...
    The trip to the major city, Balckyeti, will take about 3 weeks of travel. The
    ...
    After the trip, you arrive in an amazing city. The buildings are HUGE!
    ...
    ornament shaped things. Once you've taken in the surroundings, the guide
    will say:

    "Here we are, the city of Belinlah. Whenever you need to go back, just go
    over to that large stable and ask one of the guides." *he points to a large
    stable, made out of the same material as everything else in this damn place.

    "Also, I'd recommend you don't stay here very long. Most of the locals don't
    like having tourists around. So do what you need to do and get out of
    here. One last thing: That large temple is the temple of the sub-Queen
    Ahkilah. Unless you were sent by her, don't talk to her. She isn't a fan of
    low-lifes talking to her. That is pretty much it. Enjoy."

    The city is quite large but it seems like most of the buildings around here
    are just house and there don't seem to be very many shops.

    As they walk around, they notice that there aren't any people like them
    around. Everyone is of a different race (with a history check > 17, they
    will notice that they are of the race Yuan-Ti [specifically most people are
    purebloods, which are somewhat human]). Everyone is also giving you all an
    odd glare. Watching your every move.

    If they attempt to talk to anyone, they will be insulted with words such as
    plebeian, scum, worthless, etc. They aren't very friendly or welcoming.

    After some time, they might find a shop, however, the shopkeeper will stop
    them at the door and say "Your kind isn't welcome here. Leave now."

    There are only a few people that they can talk to in order to get
    information about the coins: the sub-queen, the guides, and someone on the
    outskirts of town called Diaab.

    --------------------------------------
    If they find Diaab, he will welcome them into his home:

    "Hello, hello, travelers! Here come inside, quickly before anyone seessss you!"

    *he will rush to get everyone into the small house as quickly as possible.

    "Welcome to the city of Belinlah! I am Diaab, the official cloud reporter
    for the Weather Advisory. That's fancy for 'I stare at the sky all day.'
    Anywayssss, what bringssss you all here? You better have a good reason, this
    is not a safe place for people whom aren't Kelczarian."

    If they talk about the coins, Diaab will explain:

    "Ah, I have heard of said coinssss. They are a currency, of sorts. Some very
    lucrative businesses use them as sort of a currency for service. You don't
    'pay' with them, you use them to get the attention of someone in the
    business. I will not ask why you need these coins but you won't be able to
    get any here unless you're under the orders of the rulers. What I mean is
    that the Kelczarian royal family keeps a very tight lease on these
    coins. They invented the use of them many years ago back when they became
    leaders in the underground drug business. Anyways, the only way you'll be
    able to get coins in Kelczar is by gaining trust from the royal family or
    finding someone who is working for the royal family and stealing or buying
    the coins off them."

    Diaab doesn't know how to find who works for the royal family nor does he
    know how to gain trust.

    "I am sorry I cannot help you much, however, I do know that sub-queen
    Ahkilah is not a happy person and would surely kill you all if she found out
    about your presence here."

    --------------------------------------

    If they walk around the city too much, 2, more snake-like, guards will
    approach you and ask you, surprisingly politely: "Will you few come with us?
    The sub-queen has ask to see you. Do not worry, she is in a good mood."
    ...
    tips on them. You are not sure what exactly they are. They are blocking the
    entrance by holding their spears in an X form. Once you get close enough,
    they move the spears and you all enter.
    ...
    floor has a white rug that travels all the way down the hallway. At the
    ...
    "Greetings travelers, I am Queen Ahkilah. I rule this city. Welcome. What is
    it that you were looking for?"

    She will cut them off is they ask how she knows that they were looking.

    "- Don't ask how I know that. I rule this city and I know what every person
    is saying and thinking. Anyways, you cannot have any coins. Those coins are
    not for scum like you to be playing with. Whatever your intent is, forget
    about it."

    If they say anything rude to her or try to attack her, the guards will
    spring into action.

    If they attempt to leave, they will notice that the guards behind them have
    formed an X with their spears.

    "You may not leave. You are not welcome here. If you think I would let
    worthless scum wonder around polluting my city, you has me mistaken. You
    will all die. Guards, please show these losers the power of Kelczar."

    The guards will attack, yes, all 8 of them.

    Use the Yuan-Ti Abomination as the guards, except they will have spear with
    petrifaction tips. On a successful attack roll, the target must roll a
    Constitution saving throw >16 or become petrified.
...
** Spies of Dracon
   ...
   - Pocket Coffin (Like a bag of holding but a coffin)

** Find the Cursed!
   In this heading, I will list the locations of the rest of the cursed group.

*** Magi
    Magi is a member of an advanced magic society called the Master Magic
    Users. They are located outside of Vet'ric, about 2 days from the main city
    walls. It is a large tower where professional magic users go to study
    magic. Magi is one of the members in this area
